...
1. Update your [pyproject.toml](pyproject.toml).
   In that file, replace the name, description, repository and author attributes with your plugin's information.
...
### Plugin Style & Description Guide

Please refer and adhere to
the [Plugin Content Guidelines](https://heigit.atlassian.net/wiki/spaces/CA/pages/1152450586/Plugin+Content+Guidelines);
this document declares up-to-date recommendations on all textual content generated by the plugin.
